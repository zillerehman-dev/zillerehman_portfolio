...
function ContactSection() {
  const socialLinks = [
    ...
    { href: personalData.kaggle, Icon: FaKaggle },
        ...
        <div className="lg:w-3/4 ">
          <div className="flex flex-col gap-5 lg:gap-9">
            <p className="text-sm md:text-xl flex items-center gap-3">
              ...
              />
              <a
                href={`https://mail.google.com/mail/?view=cm&fs=1&to=${encodeURIComponent(personalData.email)}`}
                target="_blank"
                rel="noreferrer"
            ...
            <p className="text-sm md:text-xl flex items-center gap-3">
              <IoMdCall
                ...
                size={36}
              />
              <a href={`tel:${personalData.phone}`} className="hover:text-[#16f2b3] transition-colors">
                {personalData.phone}
              </a>
            </p>
            <p className="text-sm md:text-xl flex items-center gap-3">
